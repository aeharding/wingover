...
`wingover:allow-check-permissions`
...
`wingover:deny-check-permissions`
...
Enables the fixes_since command without any pre-configured scope.
...
`wingover:deny-fixes-since`

</td>
<td>

Denies the fixes_since command without any pre-configured scope.
...
`wingover:deny-request-permissions`
...
`wingover:allow-set-waypoints`

</td>
<td>

Enables the set_waypoints command without any pre-configured scope.
...
`wingover:deny-set-waypoints`

</td>
<td>

Denies the set_waypoints command without any pre-configured scope.
...
Enables the start_watch command without any pre-configured scope.
...
`wingover:deny-start-watch`

</td>
<td>

Denies the start_watch command without any pre-configured scope.
...
`wingover:allow-stop-watch`

</td>
<td>

Enables the stop_watch command without any pre-configured scope.
...
`wingover:deny-storekit-manage-subscriptions`
